<template lang="pug">
  ...
  main
    ...
    .content
      h1 Plugins
      p Plugins are ways to extend the functionality of the the horsepower http server.
      ...
      prism(language="javascript").
        module.exports = [
          // This is a horsepower plugin inside of node_modules
          'plugin-a',
          // This is a horsepower plugin outside of node_modules
          './plugins/plugin-b'
        ]
      ...
      prism(language="javascript").
        const { Plugin } = require('@horsepower/server')
